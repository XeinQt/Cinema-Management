                    ...
                    <table class="w-full bg-white shadow-md rounded-lg overflow-hidden" id="mallsTable">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="py-3 px-6">{{ $manager->manager_id }}</td>
                                <td class="py-3 px-6">{{ $manager->first_name }}</td>
                                <td class="py-3 px-6">{{ $manager->last_name }}</td>
                                <td class="py-3 px-6">{{ $manager->email }}</td>
                                <td class="py-3 px-6">{{ $manager->phonenumber }}</td>
